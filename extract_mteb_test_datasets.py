...
def parse_args():
    parser = argparse.ArgumentParser(description="Extract datasets and test splits from an MTEB benchmark.")
    #parser.add_argument("--benchmark", type=str, required=True, help="Name of the benchmark (e.g., mteb_eng_v2, MTEB(eng, v2))")
    parser.add_argument("--output_file", type=str, default="./results/mteb_datasets", help="Path to the output text file. If not provided, prints to stdout.")
