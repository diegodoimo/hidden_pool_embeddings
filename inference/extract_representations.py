...
class extract_activations:
    ...
    def _gather_and_update_distributed(self, mask, is_last_batch):
        ...
        for _, (name, hidden_state) in enumerate(self.hidden_states_tmp.items()):
            ...
            if self.rank == 0:
                ...
                num_current_tokens = self._update_hidden_state_distributed(
    ...
    def _update_hidden_state_distributed(
        self, states_list, seq_len_list, name, is_last_batch
    ):
    ...
    def extract(self, dataloader, tokenizer):
        ...
        for i, data in enumerate(dataloader):
            ...
            if self.world_size > 1:
                self._gather_and_update_distributed(mask, is_last_batch)
