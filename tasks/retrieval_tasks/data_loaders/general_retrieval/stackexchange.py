...
# def load_stackexchange_all_subjects(
...
#                 print(
#                     f"  Loading subject {i+1}/{len(STACKEXCHANGE_SUBJECTS)}: {subject}"
#                 )
...
#     if rank == 0:
#         print(
#             f"Loaded {len(all_datasets)} subjects in {(time.time()-start_total)/60:.2f} min"
#         )
