...
RETRIEVAL_SUBSET = {
    task
    for task, task_type in NAME_TO_TASK_TYPE.items()
    if task_type not in ["Clustering", "Classification"]
}
...
NAME_TO_TASK_SUBTASK_PATH = {
    ...
    "fiqa2018": {
        "parent_folder": "retrieval",
        "subparent_folder": "domain_specific_qa",
    },
    ...
    "s2orc_title_abstract": {
        "parent_folder": "retrieval",
        "subparent_folder": "scientific_doc_retrieval",
    },
    ...
    "sentence_compression": {
        "parent_folder": "retrieval",
        "subparent_folder": "summarization",
    },
    "stackexchange_dup_s2s": {
        "parent_folder": "retrieval",
        "subparent_folder": "paraphrase_detection",
    },
    ...
    # Binary classification tasks
    "toxic_conversations": {
        "parent_folder": "binary_classification",
        "subparent_folder": None,
    },
