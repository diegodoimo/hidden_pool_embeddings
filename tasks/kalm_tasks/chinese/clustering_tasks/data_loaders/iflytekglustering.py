...
class IFlyTekClustering(AbsTask):
    """IFlyTek Chinese app description classification dataset."""

    language = "zh"

    hf_name = "sentence-transformers/iflytek"
    split = "train"
    ...
    metadata = TaskMetadata(
        type="Clustering",
        prompt={
            "query": "Classify app descriptions by category"
        },
    )
