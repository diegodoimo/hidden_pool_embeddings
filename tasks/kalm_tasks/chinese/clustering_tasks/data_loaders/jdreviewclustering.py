...
class JDReviewClustering(AbsTask):
    """JDReview Chinese product review classification dataset."""

    language = "zh"

    hf_name = "sentence-transformers/jdreview"
    split = "train"
    ...
    metadata = TaskMetadata(
        type="Clustering",
        prompt={
            "query": "Classify product reviews by sentiment"
        },
    )
