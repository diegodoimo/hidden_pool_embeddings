...
class OnlineShoppingClustering(AbsTask):
    """OnlineShopping Chinese product review classification dataset."""

    language = "zh"

    hf_name = "sentence-transformers/onlineshopping"
    split = "train"
    ...
    metadata = TaskMetadata(
        type="Clustering",
        prompt={
            "query": "Classify online shopping reviews by sentiment"
        },
    )
