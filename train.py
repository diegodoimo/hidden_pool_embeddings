...
class Trainer:
    ...
    def train(
        ...
        if args.measure_baselines:
            self.model.eval()
            results, summary = evaluator.evaluate(self.model, batch_size=args.per_device_eval_batch_size)
            self.model.train()
        ...
        for epoch in range(args.num_train_epochs):
            ...
            eval_tasks = get_eval_tasks("mteb_eng_v2", task_types=["Retrieval", "Summarization", "STS", "Reranking"])
